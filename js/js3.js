...
const menuData = {
    ...
    salades:[
        ...
        {
            name:"Salade Hawai",
            description:"Kip, ananas en cocktailsaus",
            price:12.00,
            image:"",
        },
    ],
    ...
    pizza:[
        {
            name:"Margherita",
            description:"Kaas en tomatensaus",
            price:8.00,
            image:"../Media/10556573_avenida_Food_pizza.jpg",
        },
        {
            name:"Quattro Formaggi",
            description:"4 soorten kasen",
            price:13.00,
            image:"",
        },
        {
            name:"Bolognese",
            description:"Tomatensaus en gehakte vlees",
            price:13.00,
            image:"",
        },
        {
        ...
        {
            name:"Primavera",
            description:"Champignons, paprika, spinazie, mais, olijven en ui",
            price:12.00,
            image:"",
        },
        {
            name:"Solo mio",
            description:"Ei, spinazie en looksaus",
            price:11.00,
            image:"",
        },
        {
        ...
        {
            name:"Capricciosa",
            description:"Salami en champignons",
            price:11.00,
            image:"",
        },
        {
            name:"Quattro Stagioni",
            description:"Salami , champignons, paprika en ansjovis",
            price:13.00,
            image:"",
        },
        {
            name:"Hawaï",
            description:"Kip en ananas",
            price:13.00,
            image:"",
        },
        {
            name:"Avenida",
            description:"Pita, kip, champignons, paprika, ui, olijven en pikante saus",
            price:15.00,
            image:"",
        },
        {
            name:"Tonno",
            description:"Ui, tonijn en looksaus",
            price:12.00,
            image:"",
        },
        {
            name:"Frutti Del Mar",
            description:"Zeevruchten en looksaus",
            price:13.00,
            image:"",
        },
        {
            name:"Scampi",
            description:"Scampi's, ui en look",
            price:14.00,
            image:"",
        },
        {
            name:"Salmone",
            description:"Zalm en ui",
            price:14.00,
            image:"",
        },
        {
            name:"Napolitana",
            description:"ANsjovis en kappertjes",
            price:10.00,
            image:"",
        },
    ],
    ...
    hoofdgerechten: [
        ...
        {
            name: "Steak",
            description: "met Currysaus, Avenidas saus, Pepersaus of Champignonsaus",
            price: 18.50,
